...
public:
	...
	bigint operator<<(long long t) {
		bigint n = *this;
		n.shl(t);
		return n;
	};
	
	friend bigint operator<<(long long l, bigint &b) {
		bigint n = l;
		n.shl(b.int_value());
		return n;
	};
...
bigint operator "" _g(unsigned long long i) {
	return bigint(i);
};

/* literal for <bigint>_g from string */
bigint operator "" _g(const char *decimal_string, size_t s) {
	return bigint(decimal_string, 10);
};
